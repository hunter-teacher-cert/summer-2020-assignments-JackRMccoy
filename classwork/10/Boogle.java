...
public class Boogle
{
  ...
  //Iterative approach - will need variables for both extremes [will return the index of the search target if present]
  public static int binSearch( ArrayList al, int target )
  {
    ...
    return -1; //placeholder to get past compiler if element not present
  } //end binSearch()
